  ...
  return (
    <div className="relative w-full h-full min-h-[600px] flex items-center justify-center">
      ...
      <div className={`relative w-[480px] h-[480px] rounded-3xl border shadow-2xl overflow-hidden ${
        ...
        {/* Central Main Element - with glow effects instead of rotation */}
        ...
        {/* Floating Icons - positioned around the container with glow effects */}
        {/* Top Left */}
        ...
        {/* Subtle grid pattern overlay with glow effect */}
        <div className={`absolute inset-0 ${theme === 'light' ? 'opacity-3' : 'opacity-5'}`}>
          <div className="w-full h-full shadow-[0_0_50px_rgba(59,130,246,0.3)] backdrop-blur-[0.5px] animate-pulse" style={{
